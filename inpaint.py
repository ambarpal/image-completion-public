...
if __name__ == '__main__':    
    ...
    DATASET = 'MNIST'
    lbd = 1 # Final loss is loss_cont + lbd * loss_perc
    RANDOM_BLACKOUT = 0.8
    ...
    corrupted_batch_X = loader.load_corrupted_batch_X(batch_size, mask_2D)
    ...
    #     GZ_ret, recon_img_ret, total_loss_ret, gen_merged_ret = sess.run(fetches=[GZ, recon_img, total_loss, gen_merged], feed_dict={M:Mask, y: corrupted_batch_X})

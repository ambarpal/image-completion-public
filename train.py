...
if __name__ == '__main__':
    ...
    loader = load_data.DataLoaderCIFAR()
    for ind in range(5):
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(num_train_iter):
            ...
            if iteration % generate_samples_every == 0:
                Z_sample_all = loader.load_batch_Z(40)
                X_sample_all = loader.load_batch_X('data/CIFAR/cifar-10-batches-py/data_batch_%d' % ((iteration % 5) + 1), 40)
